  ...
  return (
    <>
      ...
      {searchable && (
        <div className="mb-4">
          <input
            ...
            className="w-full sm:w-64 px-3 py-1.5 text-base text-gray-900 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
          />
        </div>
      )}
      ...
      {!loading && filteredData.length > 0 && (
        <div className="mt-4 py-4 px-2 flex flex-row flex-wrap items-center justify-around gap-2 sm:gap-4">
